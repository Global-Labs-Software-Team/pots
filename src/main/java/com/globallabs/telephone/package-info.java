 ...
 * <p>
 * The Telephone is the object that provides the APi for the telephone
 * along with its constructor and methods. It is an abstraction of
 * TelephoneFunctions.java (see the {@link com.globallabs.abstractions.TelephoneFunctions} class
